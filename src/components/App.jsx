...
const App = () => {
	...
	const listTopTenStorage = localStorage.getItem('ListTopTen')
	...
	const endGame = () => {
		...
		if (startTime) {
			...
			setList([
				...getListTopTenSorted(list),
				{ date: getDateCreation(), time: timeElapsed.toFixed(2) },
			])
		}
		setIsPlaying(false)
	}
	...
	useEffect(() => {
		localStorage.setItem('ListTopTen', JSON.stringify(list))
	}, [list])
